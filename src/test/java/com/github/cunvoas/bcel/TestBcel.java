...
public class TestBcel {
  ...
  @Test
  public final void testSiren() {
	    BcelPojo pojo = new BcelPojo();
	    pojo.setNotNull("");
	    pojo.setSiren("732829320");
  ...
  @Test
  public final void testSiret() {
	    BcelPojo pojo = new BcelPojo();
	    pojo.setNotNull("");
	    pojo.setSiret("73282932000074");
  ...
  @Test
  public final void testTelephoneFr() {
	    BcelPojo pojo = new BcelPojo();
	    pojo.setNotNull("");
	    pojo.setTelephoneFr("+33123456789");
	    
	    Set<ConstraintViolation<BcelPojo>> constraintViolations = validator.validate(pojo);
	    Assert.assertEquals(0, constraintViolations.size());

	    pojo.setTelephoneFr("0123456789");
	    constraintViolations = validator.validate(pojo);
	    Assert.assertEquals(0, constraintViolations.size());
